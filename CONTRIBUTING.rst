...
hopla is fully open-source and as such users are welcome to fork, clone and/or reuse the software freely.
...
The easiest way to contribute to hopla is by raising a "New issue". This will give you the opportunity to ask questions, report bugs or even request new features.
...
Users are of course welcome to ask any question relating to hopla and we will endeavour to reply as soon as possible.
...
If you discover a bug while using hopla please include the following details in the issue you raise:
...
If you believe hopla could be improved with the addition of extra functionality or features feel free to let us know.
...
If you would like to take a more active roll in the development of hopla you can do so by submitting a "Pull request".
A Pull Requests (PR) is a way by which a user can submit modifications or additions to the hopla package directly.
...
All contributions should adhere to the following style guides currently implemented in hopla:

* all code should be compatible with the hopla dependencies.
